      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="card mt-5">
            ...
            $sql = "SELECT CONCAT(c.CarLetter, ' ', c.CarID) AS CarNumber,CONCAT(m.BranchName, ' ', m.CarName) AS Model,m.CarType,m.Fuel,m.CarSize,m.Price,c.CarID,c.ModelID,c.CarStatus,c.City FROM cartable c,carmodeltable m WHERE m.ModelID =c.ModelID";
