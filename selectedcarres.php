...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card mt-5">
                        ...
                        r.ReservationTime,q.CustomerName FROM reservationtable r,cartable c,carmodeltable m ,receipttable f,customertable q
          ...
          <ul class="list-group list-group-horizontal">
             <li class="list-group-item col-1">' . $row["CarID"] . '</li>
