        ...
        <div class="col-12">
          <div class="card mt-5">
            ...
            <li class="list-group-item col-1">CarID</li>
              ...
              <li class="list-group-item col-2">Customer Name</li>
            ...
            $ccity = $_SESSION['carcity'];
            $sql = "SELECT CONCAT(m.BranchName, ' ', m.CarName) AS Model,c.ModelID,CONCAT(c.CarLetter, ' ', c.CarID ) AS CarNo ,r.Pickupday,r.Dropoffday,c.City,
            r.Payment,r.ReservationID,r.ReservationTime,cu.CustomerName  FROM reservationtable r,cartable c,carmodeltable m ,receipttable f,customertable cu
            WHERE   m.ModelID = c.ModelID AND r.CarID = c.CarID AND r.CustomerID = cu.CustomerID AND c.City = '$ccity'
